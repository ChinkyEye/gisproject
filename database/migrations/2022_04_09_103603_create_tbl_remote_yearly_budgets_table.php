...
class CreateTblRemoteYearlyBudgetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_remote_yearly_budgets', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_remote_yearly_budgets');
    }
}
