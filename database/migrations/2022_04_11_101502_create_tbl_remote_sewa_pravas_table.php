...
class CreateTblRemoteSewaPravasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_remote_sewa_pravas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_remote_sewa_pravas');
    }
}
