...
class CreateTblRemoteAainKanunsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_remote_aain_kanuns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_remote_aain_kanuns');
    }
}
