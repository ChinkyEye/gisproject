...
@section('content')
<?php $page = substr((Route::currentRouteName()), 16, strpos(str_replace('admin.','',Route::currentRouteName()), ".")); ?>
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6 pl-1">
        <h1 class="text-capitalize">User {{ $page }}</h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  <div class="card card-info">
    <form role="form" method="POST" action="{{route('superadmin.user.update',$users->id)}}" class="signup" id="signup">
      <div class="card-body">
        @method('PATCH')
        @csrf
      ...
      <div class="card-footer justify-content-between">
        <button type="submit" class="btn btn-info text-capitalize">Update User</button>
      </div>
    </form>
  </div>
</section>
