        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-2">
                  <a href="{{route('superadmin.introduction.create')}}" class="btn btn-flat btn-danger btn-block text-capitalize" style="color:#fff">Add {{ $page}} <i class="fas fa-plus fa-fw"></i></a>
                </div>
              </div>
            </div><!-- /.card-header -->
            <div class="card-body">
