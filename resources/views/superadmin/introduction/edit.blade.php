     ...
     <div class="card-body" >
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          <img id="blah" src="{{URL::to('/')}}/images/introduction/{{$datas->document}}" onclick="document.getElementById('imgInp').click();" alt="your image" class="img-thumbnail" style="width: 175px;height: 140px"/>
