...
<section class="content">
  <div class="card">
    <form role="form" method="POST" action="{{route('superadmin.pradeshsarkar.update', $datas->id)}}" enctype="multipart/form-data">
      @method('PATCH')
      @csrf
      <div class="modal-body" >
        <div class="form-group">
          ...
          @enderror
          <input type="text"  class="form-control max" id="title" placeholder="Enter title" name="title"  autocomplete="off" value="{{ $datas->title }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <img id="blah" src="{{URL::to('/')}}/images/pradeshsarkar/{{$datas->document}}" onclick="document.getElementById('imgInp').click();" alt="your image" class="img-thumbnail" style="width: 175px;height: 140px"/>
