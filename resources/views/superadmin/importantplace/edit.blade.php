...
<section class="content">
  <div class="card">
    <form role="form" method="POST" action="{{route('superadmin.importantplace.update', $datas->id)}}" enctype="multipart/form-data">
       @method('PATCH')
       @csrf
      <div class="card-body" >
        <div class="form-group">
          <label for="title">Title<span class="text-danger">*</span></label>
          <input type="text"  class="form-control max" id="title" placeholder="Enter the title" name="title" autocomplete="off" autofocus value="{{ $datas->title }}">
          @error('title')
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <img id="blah" src="{{URL::to('/')}}/images/importantplace/{{$datas->document}}" onclick="document.getElementById('imgInp').click();" alt="your image" class="img-thumbnail" style="width: 175px;height: 140px"/>
