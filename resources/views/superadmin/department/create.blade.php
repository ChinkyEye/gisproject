...
<section class="content">
  <div class="card card-info">
    <form role="form" method="POST" action="{{route('superadmin.department.store')}}" enctype="multipart/form-data">
      <div class="card-body">
        @csrf
        <div class="form-group">
          <label for="office_name">Office Name<span class="text-danger">*</span></label>
          <input type="text"  class="form-control max" id="office_name" placeholder="Enter office name" name="office_name" autocomplete="off" autofocus value="{{ old('office_name') }}">
          @error('office_name')
